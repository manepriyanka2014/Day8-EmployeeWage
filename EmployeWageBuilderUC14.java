...
class EmployeWageBuilderUC14 implements EmpWageInterface {
	    //constants
	    ...
	    public static void main(String[] args) {
	        // creating object
	    	EmployeWageBuilderUC14 employeeWageBuilder = new EmployeWageBuilderUC14();
	        // calling the objects
	    	EmployeWageBuilderUC14.addCompanyWage("DMart", 100, 20, 100);
	    	EmployeWageBuilderUC14.addCompanyWage("Reliance", 150, 25, 110);
	    	EmployeWageBuilderUC14.computeEmpWage();
